                    ...
                    <div class="row">
                      <div class="col-md-6 form-group">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input type="title" class="form-control" v-model="form.title" :class="{ 'is-invalid': form.errors.has('title') }">
...
export default {
  ...
  methods: {
    saveupdate:function(){
      this.form.post('/about/update').then((response)=>{
        this.$message({
    ...
    Editabout:function(){
        axios.get('/about/edit/'+ this.$route.params.slug).then((response)=>{
